...
- **Asymmetric Split Hero (Design Variance = 8)**:
  - Left: Authoritative executive briefing with live production telemetry: ₹40+ Cr GMV transacted, 18 banking issuers, 92% log cut, 1.5-day onboarding.
...
- **Production Dossier (Experience)**:
  - **Twid**: Software Developer (Jan 2025 – Present) — 18 banking issuers, config-driven proxy, ₹40+ Cr GMV, 92% log reduction, concurrency race-condition mitigations.
...
- **Verified Milestones & Academic Pedigree**:
  - Twid Hackathon Winner (AR Geolocation Rewards), ₹40+ Cr GMV, 92% log cut, 300+ LeetCode DSA.
